...
class CUP$IRParser$actions {
    ...
    public final java_cup.runtime.Symbol CUP$IRParser$do_action_part00000000(
        ...
        case 0: // $START ::= compunit EOF 
            {
                Object RESULT = null;
                IRCompUnit start_val = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
                RESULT = start_val;
        ...
        case 1: // compunit ::= LPAREN COMPUNIT name ctor_or_data_or_funcdecl_list RPAREN 
            {
                ...
                String n = CUP$IRParser$stack.elementAt(CUP$IRParser$top-2).value();
                List<Object> cdf_list = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
        ...
        case 3: // ctor_or_data_or_funcdecl_list ::= ctor_or_data_or_funcdecl_list_non_empty 
            {
                List<Object> RESULT = null;
                List<Object> l = CUP$IRParser$stack.peek().value();
                 RESULT = l; 
                CUP$IRParser$result = parser.getSymbolFactory().newSymbol("ctor_or_data_or_funcdecl_list",1, RESULT);
            }
            return CUP$IRParser$result;
        ...
        case 4: // ctor_or_data_or_funcdecl_list_non_empty ::= LPAREN ctor_or_data_or_funcdecl RPAREN 
            {
                List<Object> RESULT = null;
                Object cdf = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
        ...
        case 5: // ctor_or_data_or_funcdecl_list_non_empty ::= ctor_or_data_or_funcdecl_list_non_empty LPAREN ctor_or_data_or_funcdecl RPAREN 
            {
                List<Object> RESULT = null;
                List<Object> cdf_list = CUP$IRParser$stack.elementAt(CUP$IRParser$top-3).value();
                Object cdf = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
        ...
        case 6: // ctor_or_data_or_funcdecl ::= name 
            {
                Object RESULT = null;
                String c = CUP$IRParser$stack.peek().value();
        ...
        case 7: // ctor_or_data_or_funcdecl ::= data 
            {
                Object RESULT = null;
                IRData d = CUP$IRParser$stack.peek().value();
        ...
        case 8: // ctor_or_data_or_funcdecl ::= funcdecl 
            {
                Object RESULT = null;
                IRFuncDecl fd = CUP$IRParser$stack.peek().value();
        ...
        case 9: // data ::= DATA ATOM LPAREN number_list RPAREN 
            {
                IRData RESULT = null;
                String a = CUP$IRParser$stack.elementAt(CUP$IRParser$top-3).value();
                List<Long> n_list = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
    ...
    RESULT = new IRData(a, rawData);
        ...
        case 11: // number_list ::= number_list_non_empty 
            {
                List<Long> RESULT = null;
                List<Long> l = CUP$IRParser$stack.peek().value();
                 RESULT = l; 
                CUP$IRParser$result = parser.getSymbolFactory().newSymbol("number_list",12, RESULT);
            }
            return CUP$IRParser$result;
        ...
        case 14: // funcdecl ::= FUNC name stmt 
            {
                ...
                String n = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
                IRStmt s = CUP$IRParser$stack.peek().value();
        ...
        case 15: // name ::= ATOM 
            {
                String RESULT = null;
                String a = CUP$IRParser$stack.peek().value();
        ...
        case 16: // stmt ::= LPAREN bare_stmt RPAREN 
            {
                IRStmt RESULT = null;
                IRStmt s = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
        ...
        case 17: // bare_stmt ::= MOVE dest expr 
            {
                IRStmt RESULT = null;
                IRExpr dest = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
                IRExpr e = CUP$IRParser$stack.peek().value();
        ...
        case 18: // bare_stmt ::= CALL_STMT num expr exprs_opt 
            {
                ...
                IRExpr target = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
                List<IRExpr> args = CUP$IRParser$stack.peek().value();
        ...
        case 20: // bare_stmt ::= SEQ stmts 
            {
                IRStmt RESULT = null;
                List<IRStmt> l = CUP$IRParser$stack.peek().value();
        ...
        case 22: // bare_stmt ::= CJUMP expr name name 
            {
                IRStmt RESULT = null;
                IRExpr e = CUP$IRParser$stack.elementAt(CUP$IRParser$top-2).value();
                String trueLabel = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
                String falseLabel = CUP$IRParser$stack.peek().value();
        ...
        case 23: // bare_stmt ::= CJUMP expr name 
            {
                IRStmt RESULT = null;
                IRExpr e = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
                String trueLabel = CUP$IRParser$stack.peek().value();
        ...
        case 24: // bare_stmt ::= LABEL name 
            {
                IRStmt RESULT = null;
                String n = CUP$IRParser$stack.peek().value();
        ...
        case 32: // bare_expr ::= op 
            {
                IRExpr RESULT = null;
                IRExpr o = CUP$IRParser$stack.peek().value();
        ...
        case 38: // op ::= ADD expr expr 
            {
                IRExpr RESULT = null;
                IRExpr x = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
                IRExpr y = CUP$IRParser$stack.peek().value();
        ...
        case 58: // stmts ::= stmts stmt 
            {
                List<IRStmt> RESULT = null;
                List<IRStmt> l = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
                IRStmt s = CUP$IRParser$stack.peek().value();
        ...
        case 60: // exprs_opt ::= exprs 
            {
                List<IRExpr> RESULT = null;
                List<IRExpr> l = CUP$IRParser$stack.peek().value();
        ...
        case 62: // exprs ::= exprs expr 
            {
                List<IRExpr> RESULT = null;
                List<IRExpr> l = CUP$IRParser$stack.elementAt(CUP$IRParser$top-1).value();
                IRExpr e = CUP$IRParser$stack.peek().value();
